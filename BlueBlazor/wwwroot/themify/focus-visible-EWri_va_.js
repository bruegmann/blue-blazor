import { g as A, c as O } from "./main.lib-mbA4nRKI.js";
function V(u, s) {
    ...
    if (typeof o != "string" && !Array.isArray(o)) {
      for (const n in o)
        if (n !== "default" && !(n in u)) {
          ...
          i && Object.defineProperty(u, n, i.get ? i : {
            enumerable: !0,
            get: () => o[n]
          });
        }
  ...
  (function(r, o) {
    ...
    function r(n) {
      ...
      function y(e) {
        ...
        return !!(v === "INPUT" && E[N] && !e.readOnly || v === "TEXTAREA" && !e.readOnly || e.isContentEditable);
      }
      function l(e) {
      ...
      function p(e) {
        e.metaKey || e.altKey || e.ctrlKey || (a(n.activeElement) && l(n.activeElement), i = !0);
      }
      function c(e) {
        i = !1;
      }
      function g(e) {
        a(e.target) && (i || y(e.target)) && l(e.target);
      }
      function w(e) {
        a(e.target) && (e.target.classList.contains("focus-visible") || e.target.hasAttribute("data-focus-visible-added")) && (d = !0, window.clearTimeout(m), m = window.setTimeout(function() {
          d = !1;
        }, 100), L(e.target));
      }
      function h(e) {
        document.visibilityState === "hidden" && (d && (i = !0), f());
      }
      function f() {
      ...
      function t(e) {
        e.target.nodeName && e.target.nodeName.toLowerCase() === "html" || (i = !1, T());
      }
...
var b = C.exports;
const F = /* @__PURE__ */ A(b), j = /* @__PURE__ */ V({
  __proto__: null,
  default: F
}, [b]);
export {
